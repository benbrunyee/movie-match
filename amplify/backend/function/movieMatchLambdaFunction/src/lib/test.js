...
var endpoint = new urlParse(appsyncUrl).hostname.toString();
var graphqlQuery = require("./query.js").mutation;
var apiKey = process.env.API_MOVIEMATCH_GRAPHQLAPIKEYOUTPUT;
exports.handler = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var req, item, signer, data;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4, new Promise(function (resolve, reject) {
                        var httpRequest = https.request(__assign(__assign({}, req), { host: endpoint }), function (result) {
                            var data = "";
